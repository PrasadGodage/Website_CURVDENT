...
<html lang="en">
    <head>
        ...
        <!-- select -->	
        <link rel="stylesheet" href="resource\assets\vendor_components\bootstrap-select\dist\css\bootstrap-select.css">

        <link rel="stylesheet" href="resource\assets\vendor_components\bootstrap-select\dist\css\bootstrap-select.min.css">

        <!-- SoftMaterial admin skins -->
        <link rel="stylesheet" href="resource/css/skins/_all-skins.css">	
              
        <!-- Select2 -->
	    <link rel="stylesheet" href="resource/assets/vendor_components/select2/dist/css/select2.min.css">	
        ...
        <style>
            ...
            #loader {
                ...
                bottom: 0;
                width: 100%;
                background: rgba(0, 0, 0, 0.75) url('resource/images/loader.gif') no-repeat center center;
                z-index: 10000;
            }
