                ...
                <div class="col-12">         
                    <div class="box">
                        <div class="box-header with-border box-controls pull-right">
                            ...
                            <button type="button" class="col-md-2 btn btn-primary" id="addappointmentBtn"><i class="fa fa-plus" aria-hidden="true"></i> New Appointment</button>
                            <!-- <button id="date" class="btn btn-xs btn-primary">Select Date -->
                            <!-- <div class=" box-controls pull-right"> -->
                                <input type="date" class="col-md-2 form-control" id="date" name="date">
                            <!-- </button> -->
                            <!-- </div> -->
                        </div>
                        <!-- /.box-header -->
