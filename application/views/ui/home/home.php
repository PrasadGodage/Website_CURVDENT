    ...
    <!-- NewsLetters -->
    <section class="section-padding mb-20" data-scroll-index="5" style="hsla(0, 0%, 70%, 0.5) background-repeat: no-repeat;" data-background="<?php echo base_url() . 'uiAssets/img/Newsletter.webp'; ?>">
