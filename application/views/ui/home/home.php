    ...
    <section class="section-padding" data-scroll-index="5" data-background="<?php echo base_url() . 'uiAssets/img/bg.jpg'; ?>">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7 animate-box" data-animate-effect="fadeInUp">
                    <h6>Contact Form</h6>
                    <form method="post" class="contact__form" action="mail.php" id="contactForm">
