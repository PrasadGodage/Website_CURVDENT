        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7 mb-30 animate-box" data-animate-effect="fadeInUp">
                    ...
                    <p>At Curvdent Hair & Face Clinic, we go beyond traditional treatments by focusing on finding the
                        root cause of your hair, scalp, and face concerns. Our dedicated team of professionals is
                        committed to improving the health of your hair and skin, ensuring long-lasting results that
                        bring out your natural beauty. Through personalized care and advanced techniques, we aim to
                        rejuvenate your appearance and boost your overall well-being. Experience the transformative
                        journey to healthier hair and a radiant face with us at Curvdent Hair & Face Clinic.</p>
                    <p></p>
        ...
        <div class="container mb-30">
            <div class="row">
                <div class="col-md-12 mb-30">
                    <h2 class="section-title" id="services" data-scroll-index="2">Our Services</h2>
...
<!-- Appointment Form -->
<section class="section-padding mb-20" data-scroll-index="5" data-background="<?php echo base_url() . 'uiAssets/img/slider/1.jpg'; ?>">
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-30">
    ...
    <!-- NewsLetters -->
    <section class="section-padding mb-20" data-scroll-index="5"  data-background="<?php echo base_url() . 'uiAssets/img/slider/2.jpg'; ?>">
                ...
                <div class="col-md-12 animate-box" data-animate-effect="fadeInUp">
                    <form class="form" id="emailForm" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input name="newsemail" type="email" id="newsemail" placeholder="Email *" required>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="betty-contact-info2">
                        <div class="feat-inner2"> <span class="icon et-phone"></span>
                            <div class="feat-info2">
                                <h5 class="text-light">Phone Text</h5>
                                <h6 class="text-light">91 43 950 950</h6>
                            </div>
                        </div>
                    </div>
                    <div class="betty-contact-info2">
                        <div class="feat-inner2"> <span class="icon et-map-pin"></span>
                            <div class="feat-info2">
                                ...
                                <h6 class="text-light">Curvdent dental clinic , navin nagar road , Sangamner.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="betty-contact-info2">
                        <div class="feat-inner2"> <span class="icon et-notebook"></span>
                            <div class="feat-info2">
                                ...
                                <h6 class="text-light">info@curvedent.com</h6>
                            </div>
                        </div>
                    </div>
                    <div class="betty-contact-info2">
                        <div class="feat-inner2"> <span class="icon et-clock"></span>
                            <div class="feat-info2">
                                <h5 class="text-light">Mon-Fri: 10 - 7</h5>
