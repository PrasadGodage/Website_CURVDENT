      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li class="treeview active menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="app-ticket.html"><i class="fa fa-circle-thin"></i>Support Ticket</a></li>
			<li><a href="calendar.html"><i class="fa fa-circle-thin"></i>Calendar</a></li>
            <li><a href="profile.html"><i class="fa fa-circle-thin"></i>Profile</a></li>
            <li><a href="userlist-grid.html"><i class="fa fa-circle-thin"></i>Userlist Grid</a></li>
			<li><a href="userlist.html"><i class="fa fa-circle-thin"></i>Userlist</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
		...
		<div class="row">
			...
			<div class="col-xl-3 col-md-6 col-6">
			  ...
			  <div class="small-box box-inverse bg-warning-gradient">
				<div class="inner">
				  <h3>87.28<sup style="font-size: 20px">%</sup></h3>
			...
			<div class="col-lg-8 col-12">
				<!-- Doughnut CHART -->
				  <div class="box">
					...
					<div class="box-body chart-responsive">
					  <div class="chart" id="property-stats" style="height: 310px;"></div>
					</div>
					<!-- /.box-body -->
				  </div>
				  <!-- /.box -->  
			  ...
			  <div class="box">
				...
				<div class="box-body">
					<ul class="list-inline text-right">
						...
						<li>
							<h5><i class="fa fa-circle mr-5 text-warning"></i>Conform</h5>
						</li>
					</ul>
				    <div class="chart" id="bar-chart" style="height: 312px;"></div>
				</div>
				<!-- /.box-body -->
			  </div>
			  <!-- /.box -->  
				...
				<div class="widget-user-header bg-blue-active" style="background: url('../images/photo1.png') center center;">
				   <div class="overlay dark">
					   <div class="widget-user-image">
						  ...
						  <h6 class="widget-user-desc">Top Agent </h6>
				   </div>
				</div>
